...
def matrix_multiplication(matrix_1, matrix_2):
    """Multiplicates 2 matrices. Function dot_product from vecotr.py library is applied here."""
    if len(matrix_1[0]) != len(matrix_2):
        raise ValueError(f"ValueError, matrices have wrong sizes, and can not be multiplicated {matrix_1}, {matrix_2}")
    result = []
    for row in matrix_1:
        new_row = []
